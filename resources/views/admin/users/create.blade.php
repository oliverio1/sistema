        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'users.store', 'class' => "needs-validation", 'novalidate', 'files' => true]) !!}
                        <div class="row">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                {!! Form::text('initials', null, ['class' => 'form-control', 'required' => 'required', 'autofocus','autocomplete' => 'off']) !!}
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                @error('password')
                                    <span class="text-danger">La contraseña del usuario es obligatorio</span>
                                @enderror
                            </div>
