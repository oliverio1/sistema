            ...
            <div class="col-md-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Edición de incidencias</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        {!! Form::model($incident, ['route' => ['incidents.update', $incident], 'method' => 'put', 'class' => "needs-validation", 'novalidate', 'files' => true]) !!}
                        <div class="row">
                            <div class="form-group col-sm-12">
                                {!! Form::label('client_id', 'Cliente:') !!}
                                {{ Form::select('client_id', $clients, null, array('class'=>'form-control', 'placeholder'=>'Selecciona el cliente', 'readonly')) }}
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                [
                                    ...
                                    'WhatsApp' => 'WhatsApp'
                                ], null, array('class' => 'form-control', 'required' => 'required', 'readonly')) !!}
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <select name="assigned" class="form-control" placeholder="Asigne un responsable para el seguimiento" required>
