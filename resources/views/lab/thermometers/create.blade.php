            ...
            <div class="col-md-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Alta de termómetros</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        {!! Form::open(['route' => 'thermometers.store', 'class' => "needs-validation", 'novalidate', 'files' => true]) !!}
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                @error('provider_id')
                                    <span class="text-danger">El proveedor de calibración es obligatorio</span>
                                @enderror
                            </div>
