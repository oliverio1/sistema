...
<html>
    ...
    <body>
        ...
        <table width="100%">
            <thead>
                <tr>
                    ...
                    <th width="30%">Clave del equipo: {{ $equipment->code }}</th>
                    <th width="20%"></th>
                </tr>
            </thead>
        </table>
        ...
        @if($cuantos == 0)
            <div>
                <p>No hay registro de mantenimiento diario</p>
            </div>
        @else
            <table width="100%" border="1">
                <thead>
                    <tr>
                        <th colspan="32">MANTENIMIENTO DIARIO</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        @for($i = 1; $i < 32; $i++)
                            <td style="{{ !in_array($i,$days) ? 'background-color:#808080;' : 'font-size: 10px;'}}">{{ in_array($i,$days) ? $realizo[$i]->details->initials : '' }}</td>
                        @endfor
                    </tr>
                    <tr>
                        <th style="font-size: 10px";>Supervisó</th>
                        @for($i = 1; $i < 32; $i++)
                            <td style="{{ !in_array($i,$days) ? 'background-color:#808080;' : 'font-size: 10px;'}}">{{ in_array($i,$days) ? $superviso[$i]->details->initials : '' }}</td>
                        @endfor
                    </tr>
                </tbody>
            </table>
        ...
        <br>
            <table width="100%" border="1">
                <thead>
                    <tr>
                        <th colspan="3">MANTENIMIENTO SEMANAL</th>
                    </tr>
                    <tr>
                        <th style="font-size: 10px";>Fecha</th>
                        <th style="font-size: 10px";>Realizó</th>
                ...
                <tbody>
                    @foreach($weekly as $w)
                        <tr>
                            <td style="font-size: 10px";>{{ $w->maintenance_date }}</td>
                            <td style="font-size: 10px";>{{ $w->realizo->details->initials }}</td>
                            <td style="font-size: 10px";>{{ $w->superviso->details->initials }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        @if($monthly->count() > 0)
            ...
            <table width="100%" border="1">
                <thead>
                    <tr>
                        <th colspan="3">MANTENIMIENTOS MENSUALES, TRIMESTRALES, SEMESTRALES Y ANUALES</th>
                    </tr>
                    <tr>
                        <th style="font-size: 10px";>Fecha</th>
                ...
                <tbody>
                    @foreach($monthly as $m)
                        <tr>
                            <td style="font-size: 10px";>{{ $m->maintenance_date }}</td>
                            <td style="font-size: 10px";>Mensual</td>
                            <td style="font-size: 10px";>{{ $m->realizo->initials }}</td>
                            <td style="font-size: 10px";>{{ $m->superviso->initials }}</td>
                        </tr>
                    @endforeach
                    @foreach($quarterly as $q)
                        <tr>
                            <td style="font-size: 10px";>{{ $q->maintenance_date }}</td>
                            <td style="font-size: 10px";>Trimestral</td>
                            <td style="font-size: 10px";>{{ $q->realizo->initials }}</td>
                            <td style="font-size: 10px";>{{ $q->superviso->initials }}</td>
                        </tr>
                    @endforeach
                    @foreach($biannual as $b)
                        <tr>
                            <td style="font-size: 10px";>{{ $b->maintenance_date }}</td>
                            <td style="font-size: 10px";>Semestral</td>
                            <td style="font-size: 10px";>{{ $b->realizo->initials }}</td>
                            <td style="font-size: 10px";>{{ $b->superviso->initials }}</td>
                        </tr>
                    @endforeach
                    @foreach($annual as $a)
                        <tr>
                            <td style="font-size: 10px";>{{ $a->maintenance_date }}</td>
                            <td style="font-size: 10px";>Anual</td>
                            <td style="font-size: 10px";>{{ $a->realizo->initials }}</td>
                            <td style="font-size: 10px";>{{ $a->superviso->initials }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
