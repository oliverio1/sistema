...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      ...
      <div>
        <p style="font-size:18px"><strong>Equipo: </strong> {{ $equipment->name }}</p>
        <p style="font-size:18px"><strong>Clave: </strong> {{ $equipment->code }}</p>
        <p style="font-size:18px"><strong>Situación: </strong> {{ $equipment->status }}
            @if($equipment->status == 'En uso')
                <span id="circlegreen"></span>
            @elseif($equipment->status == 'En reparación')
                <span id="circleyellow"></span>
            @else
                <span id="circlered"></span>
            @endif
        </p>
        @if($equipment->prevent1 == '2000-01')
        @else
            <p style="font-size:18px"><strong>Mantenimientos: </strong>{{ $equipment->prevent1 }} / {{ $equipment->prevent2 }}</p>
        @endif
        <p style="font-size:18px"><strong>Contacto para mantenimiento </strong><br>{{ $equipment->provider->name }}<br>{{ $equipment->provider->cel_phone }}</p>
      </div>
    </header>
  </body>
</html>