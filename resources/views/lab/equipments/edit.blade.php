        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::model($equipment, ['route' => ['equipments.update', $equipment], 'method' => 'put', 'class' => "needs-validation", 'novalidate', 'files' => true]) !!}
                        <div class="row">
                            <div class="form-group col-sm-12">
                                {!! Form::label('name', 'Nombre del equipo:') !!}
                                {!! Form::text('name', null, ['class' => 'form-control', 'required' => 'required', 'autofocus','autocomplete' => 'off']) !!}
                                <div class="invalid-feedback">
                                    Ingrese el nombre del equipo
                                </div>
                                @error('name')
                                    <span class="text-danger">El nombre del equipo es obligatorio</span>
                                @enderror
                            </div>
                            <div class="form-group col-sm-12">
                            ...
                            <div class="form-group col-sm-12">
                                {{ Form::label('provider_id', 'Encargado de mantenimiento') }}
                                {{ Form::select('provider_id', $providers, null, array('class'=>'form-control', 'placeholder'=>'Selecciona el proveedor de mantenimiento')) }}
                                <div class="invalid-feedback">
                                    Seleccione el proveedor de mantenimiento
                                </div>
                                @error('provider_id')
                            ...
                            <div class="form-group col-sm-6">
                                {!! Form::label('prevent1', 'Primer mantenimiento preventivo:') !!}
                                {!! Form::month('prevent1', null, ['class' => 'form-control', 'required' => 'required']) !!}
                                <div class="invalid-feedback">
                                    Seleccione el mes en el que debe realizar el mantenimiento preventivo
                                </div>
                                @error('prevent1')
                                    <span class="text-danger">La fecha de mantenimiento es obligatoria</span>
                                @enderror
                            </div>
                            <div class="form-group col-sm-6">
                                {!! Form::label('prevent2', 'Segundo mantenimiento preventivo:') !!}
                                {!! Form::month('prevent2', null, ['class' => 'form-control', 'required' => 'required']) !!}
                                <div class="invalid-feedback">
                                    Seleccione el mes en el que debe realizar el mantenimiento preventivo
                                </div>
                                @error('prevent2')
