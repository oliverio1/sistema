...
<body>
	...
	<div class="main-content">
        ...
        <br>
        <hr>
        <a href="http://127.0.0.1:8000/" class='btn btn-success btn-lg' style="color:white">Volver</a>
        <a href="http://127.0.0.1:8000/incidencias" class='btn btn-warning btn-lg' style="color:white">Registrar nueva solicitud</a>
	</div>
