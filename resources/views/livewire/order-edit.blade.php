<div>
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::model($order, ['route' => ['orders.update', $order], 'method' => 'put', 'class' => 'needs-validation','novalidate', 'files' => true]) !!}
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        {!! Form::text('clave', $order->clave, ['wire:model' => 'clave', 'class' => 'form-control']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        {!! Form::text('name', $order->name, ['wire:model' => 'name', 'class' => 'form-control', 'required' => 'required']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        @error('sex')
                            <span class="text-alert">El sexo es obligatorio</span>
                        @enderror
                    </div>
                    <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        @error('age')
                            <span class="text-alert">La edad del paciente es obligatoria</span>
                        @enderror
                    </div>
